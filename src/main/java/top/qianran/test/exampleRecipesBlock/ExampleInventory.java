 ...
 * Originally by Juuz
 */
public class ExampleInventory implements Inventory {

    private final DefaultedList<ItemStack> items = DefaultedList.ofSize(2, ItemStack.EMPTY);

    public ExampleInventory(ItemStack itemStack1, ItemStack itemStack2) {
        items.set(0, itemStack1);
        items.set(1, itemStack2);
    }
